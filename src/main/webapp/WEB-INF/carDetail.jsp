...
function validateBid() {
    var price = document.getElementsByName("bidderPrice")[0].value;
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<!-- Bid Form -->
										<sf:form action="bid" method="post" class="was-validated" modelAttribute="bidding" onsubmit="return validateBid()">
    <div class="mb-3 mt-3">
        <label for="name" class="form-label">Bid Price (RM):</label> 
