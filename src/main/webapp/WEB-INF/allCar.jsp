						...
						<c:forEach items="${cars}" var="c" varStatus="status">
							<tr>
								...
								<td><a type="button" class="btn btn-primary"
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<sf:form action="/edit_car?cid=${c.id}" method="post"
														...
														<button type="submit" class="btn btn-primary d-block w-100 text-center">Edit</button>
													</sf:form>
													<script>
						            $(document).ready(() => {
									...
									href="/delete_car?cid=${c.id}" onclick="return confirm('Are you sure you want to delete?')"> <i class="far fa-trash-alt"></i>
								</a></td>
